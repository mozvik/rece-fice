...
export class ContactComponent implements OnInit {
  ...
  get gdpr() { return this.contactFormGroup.get('gdpr'); }
  ...
  sendMessage(form: NgForm) {
    ...
    this.isLoading = true
    this.apiService.postContactData(this.contactFormGroup.value)
      .pipe(
      ...
      next: (val) => {
        if (val.ok === true) {
          ...
          this.messageService.showSnackBar('Üzenet sikeresen elküldve!', 'success');
          form.reset()
        }
      },
      error: (e) => {
        ...
        this.isLoading = false
        this.messageService.showSnackBar('Hiba történt az üzenet küldése közben!', 'error');
      }
    })
  }
}
