...
export class RecoveryComponent implements OnInit {
  ...
  get password1() {
    return this.resetPasswordFormGroup.get('password1');
  }
  get password2() {
    return this.resetPasswordFormGroup.get('password2');
  }
  ...
  reset() {
    ...
    this.authService
      .resetPassword(
        this.token,
        this.resetPasswordFormGroup.controls['password1'].value,
        this.resetPasswordFormGroup.controls['password2'].value
      )
      ...
      .subscribe({
        next: (response) => {
          if (response.hasOwnProperty('errors')) {
            ...
            this.resetPasswordFormGroup.controls['password1'].setErrors({
              pwApi: response.errors.password1,
            });
            this.resetPasswordFormGroup.controls['password2'].setErrors({
              pwApi: response.errors.password2,
            });
