...
export class ProfileComponent implements OnInit {
  ...
  constructor(
    ...
    this.activatedRoute.data.subscribe((data) => {
      this.userRecipes = this.dataService.createRecipes(
        data['userRecipes'].items
      );
      this.userFavorites = this.dataService.createRecipes(
  ...
  createRecipes(data: any[]): void {
    ...
    this.dataService.userRecipeList =
      this.dataService.userRecipeList.concat(array);
  }
}
