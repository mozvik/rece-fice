...
export class EditAvatarComponent implements OnInit {
  @ViewChild('avatar_file_input', { static: true })
  avatar_file_input?: ElementRef;
  ...
  get avatar() {
    return this.avatarFormGroup.get('avatar');
  }
