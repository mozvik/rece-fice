...
export class RegisterComponent implements OnInit {
  ...
  get passwordNew() {
    return this.registerFormGroup.get('passwordNew');
  }
  get passwordConfirm() {
    return this.registerFormGroup.get('passwordConfirm');
  }
  get name() {
    return this.registerFormGroup.get('name');
  }
  get gdpr() {
    return this.registerFormGroup.get('gdpr');
  }
        ...
        next: (res) => {
          if (res.hasOwnProperty('errors')) {
            ...
            this.messageService.showSnackBar(
              'Sikeres regisztráció. Lépj be a fiókodba.',
              'success'
            );
