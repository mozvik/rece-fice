...
export class DetailsComponent implements OnInit {
  ...
  constructor(
    ...
    if (this.isLoggedIn && this.user) {
      this.authService
        .getFavoritesSimple(this.user.userId)
        .subscribe((favorites) => (this.favs = favorites));
    }
  }
  ...
  setFav() {
    this.authService
      .setFavorite(this.user!.userId, this.recipe!.id!, true)
      .subscribe((res) => {
  ...
  unsetFav() {
    this.authService
      .setFavorite(this.user!.userId, this.recipe!.id!, false)
      .subscribe((res) => {
        this.messageService.showSnackBar(res, 'success');
