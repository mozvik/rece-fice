...
export class AuthService {
  ...
  public logout(): Observable<any> {
    ...
    return this.http.post<any[]>(this.serverUrl + '?logout', fData, {
      withCredentials: true,
    });
  }

  public credentials(): Observable<any> {
    return this.http.get<any[]>(this.serverUrl + '?credentials', {
      withCredentials: true,
    });
  }

  public userlist(): Observable<any> {
    return this.http.get<any[]>(this.serverUrl + '?userlist', {
      withCredentials: true,
    });
  }
  ...
  public banUser(userId: string): Observable<any> {
    ...
    return this.http.post<any[]>(this.serverUrl + '?banuser', fData, {
      withCredentials: true,
    });
  }
  ...
  public activateUser(userId: string): Observable<any> {
    let fData = new FormData();
    fData.append('id', userId);
    return this.http.post<any[]>(this.serverUrl + '?activateuser', fData, {
      withCredentials: true,
    });
  }
  ...
  public register(formData: any): Observable<any> {
    ...
    return this.http.post<any[]>(this.serverUrl + '?register', fData, {
      withCredentials: true,
    });
  }
  ...
  public userUpdate(formData: any): Observable<any> {
    ...
    return this.http.post<any[]>(this.serverUrl + '?user', fData, {
      withCredentials: true,
    });
  }
  public avatarUpload(formData: any): Observable<any> {
    ...
    return this.http.post<any[]>(this.serverUrl + '?avatar', fData, {
      withCredentials: true,
    });
  }
  public avatarDelete(userId: string): Observable<any> {
    ...
    fData.append('id', userId);
    return this.http.post<any[]>(this.serverUrl + '?avatar/delete', fData, {
      withCredentials: true,
    });
  }

  public userInfo(id: string): Observable<any> {
    return this.http.get<any>(this.serverUrl + '?info&id=' + id);
  }
  ...
  public getFavoritesSimple(userId: string): Observable<any[]> {
    return this.http.get<any[]>(
      this.serverUrl + '?favorites/simple&user=' + userId,
      { withCredentials: true }
    );
  }
  ...
  public setFavorite(
    ...
    return this.http.post<any[]>(this.serverUrl + '?favorite', fData, {
      withCredentials: true,
    });
  }
  ...
  public resetPassword(
    ...
    return this.http.post<any[]>(this.serverUrl + '?reset', fData, {
      withCredentials: true,
    });
  }
  ...
  public passwordRecovery(email: string): Observable<any> {
    ...
    return this.http.post<any[]>(this.serverUrl + '?recovery', fData, {
      withCredentials: true,
    });
  }

  public validateRecoveryToken(token: string): Observable<any> {
    return this.http.get<any[]>(this.serverUrl + '?recovery&token=' + token, {
      withCredentials: true,
    });
  }
