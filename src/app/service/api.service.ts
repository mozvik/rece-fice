...
export class APIService {
  ...
  private isServerReady(): Observable<any> {
    return this.http.get<any[]>(this.serverUrl + '?ready=' + this.apiKey, {
  ...
  public search(
    ...
    return this.http.post<any[]>(this.serverUrl + '?search', filterData);
  }

  public getRecipe(id: string): Observable<any[]> {
    return this.http.get<any[]>(this.serverUrl + '?recipe&id=' + id, {
      withCredentials: true,
    });
  }
  ...
  public postRecipe(formData: any): Observable<any> {
    ...
    return this.http.post<any[]>(this.serverUrl + '?recipe', fData, {
      withCredentials: true,
    });
  }
  ...
  public putRecipe(formData: any): Observable<any> {
    ...
    return this.http.post<any[]>(
      this.serverUrl + '?recipe&id=' + formData.recipeId,
      fData,
      { withCredentials: true }
    );
  }
  ...
  public recipeCount(): Observable<any> {
    ...
    return this.http.get<any[]>(query, { withCredentials: true });
  }
  ...
  public review(
    ...
    return this.http.post<any[]>(this.serverUrl + '?review', fData, {
      withCredentials: true,
    });
  }
  ...
  public moderateReview(id: string): Observable<any> {
    let fData = new FormData();
    fData.append('id', id);
    return this.http.post<any[]>(this.serverUrl + '?moderatereview', fData, {
      withCredentials: true,
    });
  }
  ...
  public activateReview(id: string): Observable<any> {
    let fData = new FormData();
    fData.append('id', id);
    return this.http.post<any[]>(this.serverUrl + '?activatereview', fData, {
      withCredentials: true,
    });
  }
  ...
  public moderateRecipe(id: string): Observable<any> {
    let fData = new FormData();
    fData.append('id', id);
    return this.http.post<any[]>(this.serverUrl + '?moderaterecipe', fData, {
      withCredentials: true,
    });
  }
  ...
  public activateRecipe(id: string): Observable<any> {
    let fData = new FormData();
    fData.append('id', id);
    return this.http.post<any[]>(this.serverUrl + '?activaterecipe', fData, {
      withCredentials: true,
    });
  }
  ...
  public subscribeGuest(email: string): Observable<any[]> {
    ...
    return this.http.post<any[]>(this.serverUrl + '?subscribe', fData, {
      withCredentials: true,
    });
  }
  ...
  public getRecipesByUser(
    ...
    return this.http.post<any[]>(this.serverUrl, fData, {
      withCredentials: true,
    });
  }
